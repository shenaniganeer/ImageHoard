...
| [`docs/design-decisions/browser-tree-rewrite-architecture.md`](docs/design-decisions/browser-tree-rewrite-architecture.md) | Browser V2: Core `FsMap` / `FsDiffStream`, flat folder model, app controllers, scroll anchoring (**FR-BR-01**–**07**, **NFR-PF-05**/**06**) |
| [`docs/design-decisions/browser-tree-viewport-anchor-persistence.md`](docs/design-decisions/browser-tree-viewport-anchor-persistence.md) | Browser V2: persisted viewport anchor (row + offset) vs `lastActedFsObject` (**FR-BR-01**, **FR-BR-04**, **NFR-PF-05**) |
| [`docs/design-decisions/browser-folder-tree-path-to-node-index.md`](docs/design-decisions/browser-folder-tree-path-to-node-index.md) | **Legacy** browser `TreeView`: `_folderTreeNodeByPath` maintenance (superseded for V2 — see rewrite ADR) |
| [`docs/design-decisions/browser-folder-tree-virtualization-itemsrepeater.md`](docs/design-decisions/browser-folder-tree-virtualization-itemsrepeater.md) | Virtualized browser tree: ItemsRepeater + flat projection; folders-only tree + image pane in V2 |
...
| [`docs/design-decisions/natural-string-comparer-name-natural-sort.md`](docs/design-decisions/natural-string-comparer-name-natural-sort.md) | **Name (natural)** string ordering: `NaturalStringComparer` (digit runs, symbol/letter tiers, mixed branch) |
...
**Name (natural) sort maintenance:** If you change [`NaturalStringComparer`](src/ImageHoard.Core/NaturalStringComparer.cs), **Name (natural)** call sites, or user-visible **Name (natural)** ordering, update [`natural-string-comparer-name-natural-sort.md`](docs/design-decisions/natural-string-comparer-name-natural-sort.md) and extend [`NaturalStringComparerTests`](tests/ImageHoard.Tests/NaturalStringComparerTests.cs) (and any other tests that encode that ordering).
