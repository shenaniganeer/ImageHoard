...
internal static class CommandCatalog
{
    ...
    [
        ...
        new("nav.nextDirectory", "Next sibling folder in the tree (same parent as the folder that contains the current image)", true, HotkeySection.Navigation),
        new("nav.prevDirectory", "Previous sibling folder in the tree (same parent as the folder that contains the current image)", true, HotkeySection.Navigation),
