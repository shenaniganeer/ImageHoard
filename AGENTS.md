...
| [`docs/design-decisions/slideshow-algorithm-p0.md`](docs/design-decisions/slideshow-algorithm-p0.md) | Tree slideshow: streaming discovery, reservoir cap, LRU eviction, shuffle vs browse enumeration (FR-SL-02/03, NFR-PF-03) |
